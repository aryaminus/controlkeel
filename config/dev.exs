...
config :controlkeel, ControlKeelWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "4Cq/mPCwp8eCQAm5FKxlOW+OrNBpujEQP2CcuzWUZRAw4I4xYrTag5L2oco/Bj9g",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:controlkeel, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:controlkeel, ~w(--watch)]}
  ]
...
config :controlkeel, dev_routes: true
