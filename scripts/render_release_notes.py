...
def main() -> None:
    ...
    print("- Augment bundles: `controlkeel-augment-native.tar.gz` and `controlkeel-augment-plugin.tar.gz`")
    ...
    print("- Augment host CLI: `npm install -g @augmentcode/auggie`")
    print("- Augment local plugin dir: `auggie --plugin-dir ./controlkeel/dist/augment-plugin`")
