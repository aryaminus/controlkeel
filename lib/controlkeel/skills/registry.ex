defmodule ControlKeel.Skills.Registry do
  ...
  defp maybe_mark_exported(targets, target, project_root, skill) do
    ...
    skill_locations = [
      ...
      Path.join(export_root, ".cursor/skills/#{skill.name}/SKILL.md"),
      Path.join(export_root, ".opencode/skills/#{skill.name}/SKILL.md"),
      Path.join(export_root, ".augment/skills/#{skill.name}/SKILL.md"),
      Path.join(export_root, ".kilo/skills/#{skill.name}/SKILL.md"),
      Path.join(export_root, ".devin/skills/#{skill.name}/SKILL.md"),
      Path.join(export_root, ".warp/skills/#{skill.name}/SKILL.md"),
  ...
  defp project_locations(project_root, name) do
    ...
    [
      ...
      Path.join(root, ".opencode/skills/#{name}/SKILL.md"),
      Path.join(root, ".augment/skills/#{name}/SKILL.md"),
      Path.join(root, ".kilo/skills/#{name}/SKILL.md"),
      Path.join(root, ".devin/skills/#{name}/SKILL.md"),
      Path.join(root, ".warp/skills/#{name}/SKILL.md"),
  ...
  defp user_locations(name) do
    [
      ...
      user_location(".cursor/skills/#{name}/SKILL.md"),
      user_location(".opencode/skills/#{name}/SKILL.md"),
      user_location(".augment/skills/#{name}/SKILL.md"),
      user_location(".kilo/skills/#{name}/SKILL.md"),
      user_location(".config/devin/skills/#{name}/SKILL.md"),
      user_location(".warp/skills/#{name}/SKILL.md"),
