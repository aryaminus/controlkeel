defmodule ControlKeelWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      counter("controlkeel.local_project.initialized.count"),
      counter("controlkeel.claude.attach.succeeded.count"),
      counter("controlkeel.session.first_finding_recorded.count"),
      counter("controlkeel.finding.approved.count"),
      ...
      summary("controlkeel.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("controlkeel.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("controlkeel.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("controlkeel.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
